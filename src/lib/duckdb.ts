// API client for DuckDB backend (for local development)
...
// This class assumes your backend API is now using DuckDB for local dev,
// so the API endpoints remain the same!
class DuckDBManager {
